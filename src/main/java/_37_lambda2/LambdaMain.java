...
public class LambdaMain {
    public static void main(String[] args) {
        ...
        // 생략이 가능하다.
        // Calculator 인터페이스에 선언된 추상메서드가 하나밖에 없기떄문에
        // -> 시그니처 특정이 가능하다.
        // 시그니처부분(메서드명, 매개변수타입, 리턴타입) 생략
        // 한줄로 리턴이 가능할때만 중괄호 + return키워드 생략가능
