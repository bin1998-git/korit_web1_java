...
public class Practice {
    public static void main(String[] args) {
        ...
        // 커스텀예외를 만들어 주세요(InvalidEmailException)
        // 검증조건
        // 1. email이 null이면 에러 생성 - 메세지: 이메일이 null입니다
        // 2. email이 빈 문자열이면 에러 생성 - 메세지: 이메일이 비어있습니다.
        // 3. email이 @가 없으면 에러 생성 - 메세지: 이메일에 @가 없습니다.
        ...
        try {
            ...
            // 구체적인 예외 클래스를 상단에 적어주는게 권장되고 있다.
