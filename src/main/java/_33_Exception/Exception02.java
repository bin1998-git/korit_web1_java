...
public class Exception02 {
    ...
    static void method2() throws MyCheckedException {
        ...
        throw new MyCheckedException("method2애서 생성");
    ...
    public static void main(String[] args) {
        ...
        2. UnChecked Exception(Runtime Exception) (런타임시점에 검사)
        ...
        // 필드로 String message를 가지고 있음. getMessage로 실행가능
        try {
            method1();
        ...
        // 참고) 예외객체를 catch해서 처리하는 로직을 담당하는 클래스를 예외핸들러
