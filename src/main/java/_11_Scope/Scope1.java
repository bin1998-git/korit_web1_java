...
public class Scope1 {
    public static void main(String[] args) {
        ...
        // 선언된 중괄호 안쪽으로는 생존가능하다 - *ja
        //
        // va의 경우*
        int m = 10; // m생존 시작 - main 메서드 전체에서 생존

        if (true) {
            int x = 20; // x생존 시작 - if 블록 안에서만 생존
            System.out.println(m); // 외부변수m은 생존
