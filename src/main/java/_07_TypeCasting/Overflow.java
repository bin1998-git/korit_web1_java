...
public class Overflow {
    public static void main(String[] args) {
        ...
        // int의 범위: -21억 ~ 21억
        long maxIntvalue = 2_147_483_647L; // int의 최대값
        long overIntvalue = maxIntvalue + 1; // int 최대값 + 1

        // 정상적인 형변환
        int intValue1 = (int) maxIntvalue; // 명시적형변환
        ...
        // 체중계가 최대 100kg까지 측정할 수 있다.
        // 130kg사람이 체중계에 올라가면, 눈금이 30kg을 가르킨다.
