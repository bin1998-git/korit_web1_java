...
public class ClassMain {
    public static void main(String[] args) {
        ...
        String[] names = {"홍길도0" , "홍길동1"}; // index끼리 동기화해서 관리
        ...
        // student1과 student2는 객체의 주소를 담은 변수다(o)
        // student1과 student2는 Student의 클래스로 만들어진 인스턴스다(o)
        ...
        3. 필드값들에 접근해서 "현대- 소나타2023년식"을 콘솔에 출력
